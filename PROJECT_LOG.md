...
| 35 | TODO | **Land the Science faculty file** — export is stashed in browser `localStorage['sci_export_b64']` (8.8 KB gzip-b64, survives reloads); write with small split chunks | 2026-06-04 | High | Data verified complete in-browser (62 programs, 265 lists, 1,261 courses, 0 errors); only the file-write failed |
...
| 40 | TODO | **Deleted-courses Jac org-pull (UQBS, org 29)** — page get-resources by organisation → every UQBS course instance ever; diff vs harvest → since-deleted set → feed `--codes-file` | 2026-06-03 | Med | See PLAN entry 2026-06-03 |
| 41 | TODO | **Wire teaching-periods.json into viewer/import scripts** — replace hardcoded codeMap in app.js semesterLabel() | 2026-06-04 | Low | Registry file exists; wiring pending |
...
│       └── (sci pending — stashed in browser localStorage, see #35)
